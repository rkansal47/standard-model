...
In this chapter, we start first with a brief review of classical field theory (Section~\ref{sec:01_qft_classical}), primarily discussing free scalar fields, before outlining the process of quantization and the emergence of particles (Section~\ref{sec:01_qft_quantization}).
...
% discusses the importance of symmetries and conservation laws in QFT.
% Finally, we conclude with a brief discussion of the standard model and its experimental successes (Section~\ref{sec:01_qft_sm}).

% Finally, we discuss symmetries and conservation laws in QFT (Section~\ref{sec:01_qft_symmetries}), which are crucial for understanding the structure of the standard model.

% (Section~\ref{sec:01_qft_interactions}).
