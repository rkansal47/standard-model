...
\newcommand{\identity}{\ensuremath{\mathbbm{1}}\xspace}
...
\newcommand{\svecp}[1]{\ensuremath{#1_{\vec{p}}\,}}
\newcommand{\ophat}[1]{\ensuremath{\hat #1_{\vec{p}}\,}}
\newcommand{\ophatd}[1]{\ensuremath{\hat #1^\dagger_{\vec{p}}\,}}
