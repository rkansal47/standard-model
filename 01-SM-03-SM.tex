...
EWSB is hypothesized to have occurred during the electroweak epoch (between around $10^{-36}$\unit{s} and $10^{-12}$\unit{s} after the big bang), where the $\SU[2]_{\mathrm{L}} \times \UU[1]_{\mathrm{Y}}$ global symmetry broke to the $\UU[1]_{\mathrm{EM}}$ of QED.
...
Having discussed QED in Chapter~\ref{sec:01_qft_gt}, we now describe the remaining two fundamental interactions: quantum chromodynamics (QCD) in Section~\ref{sec:01_sm_qcd}; and weak interactions and electroweak unification in Section~\ref{sec:01_sm_ew}.
We conclude with a discussion of phenomena that the SM cannot explain, and what my lie beyond, in Section~\ref{sec:01_sm_bsm}.
...
\begin{figure}[ht]
	...
	\caption{An example of real jets in an event collected by CMS and identified in my dissertation~\cite{Bauerdick:2011zz, CMS:2024les}.
...
The trilinear self-coupling, in particular, can be accessed at the LHC through pair production of the Higgs boson (\HH).
\HH production also allows exclusive access to the quartic $hhVV$ couplings, where $V$ is a weak gauge boson.
This is why measuring Higgs pair production is such a key target of the LHC and upcoming high-luminosity LHC physics programs.
...
% \footnote{This was one motivation behind the search for new Higgs bosons described in my dissertation.}
